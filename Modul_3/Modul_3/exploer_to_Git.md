...
[Как использовать синтаксис Markdown при создание файла README.md ] <https://youtu.be/syrGPPekLHQ/>
<!-- 
*   [Общее](https://github.com/ValenHouse/Apple/tree/main/Git-commands/tree/master/git##Общее)
*   [Консольные команды](https://github.com/ValenHouse/Apple/tree/main/Git-commands/tree/master/git##Консольные-команды)
*   [Примеры для реальной работы](https://github.com/ValenHouse/Apple/tree/main/Git-commands/tree/master/git## Основные примеры к действию) -->
...
[Посмотреть]:https://youtu.be/wSVVDBPX2S4/
...
## Основные примеры к действию

Собирал коллекцию примеров работы.
